...
class ServiceInProcessOrderDetailsModel {
  bool status;
  InProcessOrderData data;
  String message;

  ServiceInProcessOrderDetailsModel({
    required this.status,
    required this.data,
    required this.message,
  });

  ServiceInProcessOrderDetailsModel copyWith({
    bool? status,
    InProcessOrderData? data,
    String? message,
  }) =>
  ...
  factory ServiceInProcessOrderDetailsModel.fromRawJson(String str) => ServiceInProcessOrderDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceInProcessOrderDetailsModel.fromJson(Map<String, dynamic> json) => ServiceInProcessOrderDetailsModel(
    status: json["status"],
    data: InProcessOrderData.fromJson(json["data"]),
...
class InProcessOrderData {
  ...
  factory InProcessOrderData.fromRawJson(String str) => InProcessOrderData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory InProcessOrderData.fromJson(Map<String, dynamic> json) => InProcessOrderData(
