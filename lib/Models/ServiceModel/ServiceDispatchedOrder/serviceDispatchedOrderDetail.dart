...
class ServiceDispatchedOrderDetailsModel {
  bool status;
  DispatchedOrderData data;
  String message;

  ServiceDispatchedOrderDetailsModel({
    required this.status,
    required this.data,
    required this.message,
  });

  ServiceDispatchedOrderDetailsModel copyWith({
    bool? status,
    DispatchedOrderData? data,
    String? message,
  }) =>
  ...
  factory ServiceDispatchedOrderDetailsModel.fromRawJson(String str) => ServiceDispatchedOrderDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceDispatchedOrderDetailsModel.fromJson(Map<String, dynamic> json) => ServiceDispatchedOrderDetailsModel(
    status: json["status"],
    data: DispatchedOrderData.fromJson(json["data"]),
...
class DispatchedOrderData {
  ...
  factory DispatchedOrderData.fromRawJson(String str) => DispatchedOrderData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DispatchedOrderData.fromJson(Map<String, dynamic> json) => DispatchedOrderData(
