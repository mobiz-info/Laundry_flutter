...
//
//     final serItemsAddCartModel = serItemsAddCartModelFromJson(jsonString);

import 'dart:convert';

SerItemsAddCartModel serItemsAddCartModelFromJson(String str) => SerItemsAddCartModel.fromJson(json.decode(str));

String serItemsAddCartModelToJson(SerItemsAddCartModel data) => json.encode(data.toJson());

class SerItemsAddCartModel {
  final bool? status;
  final SerItemsAddCartData? data;
  final String? message;

  SerItemsAddCartModel({
    this.status,
    this.data,
    this.message,
  });

  factory SerItemsAddCartModel.fromJson(Map<String, dynamic> json) => SerItemsAddCartModel(
    status: json["status"],
    data: json["data"] == null ? null : SerItemsAddCartData.fromJson(json["data"]),
...
class SerItemsAddCartData {
  ...
  factory SerItemsAddCartData.fromJson(Map<String, dynamic> json) => SerItemsAddCartData(
