...
//
//     final serCartListModel = serCartListModelFromJson(jsonString);

import 'dart:convert';

SerCartListModel serCartListModelFromJson(String str) => SerCartListModel.fromJson(json.decode(str));

String serCartListModelToJson(SerCartListModel data) => json.encode(data.toJson());

class SerCartListModel {
  final bool? status;
  final SerCartListData? data;
  ...
  factory SerCartListModel.fromJson(Map<String, dynamic> json) => SerCartListModel(
    status: json["status"],
    data: json["data"] == null ? null : SerCartListData.fromJson(json["data"]),
...
class SerCartListData {
  ...
  factory SerCartListData.fromJson(Map<String, dynamic> json) => SerCartListData(
