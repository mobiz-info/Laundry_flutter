...
class ItemWiseReportScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ItemWiseReportScreenState();
}

class ItemWiseReportScreenState extends State<ItemWiseReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: Appbar(text: 'Item wise Order Report',),
      ),
