...
class PendingPickupScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PendingPickupScreenState();
}

class PendingPickupScreenState extends State<PendingPickupScreen> {
  int count = 0;
  bool yellow_express = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child:Appbar(text: 'Pick Up pending List',),
      ),
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return yellow_express== true ?Container(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DecoratedBox(
                                        ...
                                        child: TextButton(
                                          onPressed: () { },
                                          child: Text('Door Lock',style: TextStyle(fontSize: 12,color: pickerPrimaryColor),),
                                        ),
                                      ),
                                    )
                                  ],
            ...
            Container(
              ...
              child: Text('Yellow Express Orders'),
            ),
          ],
        ),
      ),
